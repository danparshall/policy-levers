...
I bring this up because from what I've found, the AI Safety community hasn't done a lot of active recruitment of senior key personnel.  As just one example, I'm reviewing materials related to the [FASR](https://www.securefrontier.ai/) program today, and while the community has adopted the "covert adversary" framework wholesale, I can't find any public indication (as of this writing) that any of the AI Safety funders have gone to Aumann or Lindell and said "hey, you know that great paper y'all wrote?  Could you take this pile of money and do some more?"  (The UK's Alignment Project does fund cryptographers, but for watermarks and backdoors, not verification.)
