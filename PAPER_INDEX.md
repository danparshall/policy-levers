...
| Critch & Russell (2023) — TASRA | Canonical *societal-scale* risk taxonomy (arXiv:2306.06924). Six risk types organized on an **accountability** axis (whose actions? actors unified? deliberate?) — a different organizing principle from Shah's mitigation axis and IAISR's active/passive axis. Cite for the structural tier | `Critch_Russell__2023--tasra_societal_scale_risks.pdf` |
| Slattery et al. (2024/2026) — AI Risk Repository | Living meta-review: **1,725 risks from 74 frameworks**; 7 domains / 24 subdomains (economic tier = domain 6, "Socioeconomic & Environmental"). Published in *Patterns* 2026 (doi:10.1016/j.patter.2026.101517). Its stated motivation — inconsistent AI-risk terminology — is directly the essay's thesis | `Slattery_Thompson__2024--ai_risk_repository.pdf` |
