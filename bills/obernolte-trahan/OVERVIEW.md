...
6. The state-AG opt-in carries both information access and an enforcement action: opted-in state AGs can sue for § 111 penalties and injunctions, subordinate to DOJ (notice, intervention, stay-on-parallel-action rules at § 111(i)(3)). Federal primacy, but not federal exclusivity.
